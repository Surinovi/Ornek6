...
public class DBAdapter {
	...
	private static final String DATABASE_NAME = "ab2016";
	private static final String DATABASE_TABLE = "androidb";
	private static final int DATABASE_VERSION = 1;

	private static final String DATABASE_CREATE = "create table androidb (id integer not null primary key autoincrement, "
			+ "isim text, email text);";
	...
	public void insertContact2(String name, String email) {		
		...
		String sql = "insert into "+DATABASE_TABLE+" ( "+KEY_ISIM+","+KEY_EMAIL+") values ('"+name+"','"+email+"')";
		db.execSQL(sql);
	...
	public Cursor getContact(long rowId) throws SQLException {
		...
		Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] {
				KEY_ROWID, KEY_ISIM, KEY_EMAIL }, KEY_ROWID + "=" + rowId,
